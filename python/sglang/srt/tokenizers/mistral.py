...
class MistralTokenizer:
    ...
    def bos_token(self) -> int:
        return self.tokenizer.id_to_piece(self.bos_token_id)

    @property
    def eos_token(self) -> int:
        return self.tokenizer.id_to_piece(self.eos_token_id)

    @property
    def pad_token(self) -> int:
        return self.tokenizer.id_to_piece(self.pad_token_id)
